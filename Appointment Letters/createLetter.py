...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <div class="text">
            <p>Dear {name}, <br><br></p>  
            <p>Welcome to the team of the ACM - Developers' Day 2024. We are excited to have you on board and look forward to the contributions you will make as {position} Team {teamName}. <br><br></p>
